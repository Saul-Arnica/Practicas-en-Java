...
public class Prestamo{
    ...
    public String toString(){
        String fecha = this.getFechaRetiro().get(Calendar.YEAR)+"/"+ this.getFechaRetiro().get(Calendar.MONTH)+"/"+this.getFechaRetiro().get(Calendar.DATE);
        if(this.getFechaDevolucion()!= null){
            String fechaDevolucion = this.getFechaDevolucion().get(Calendar.YEAR)+"/"+ this.getFechaDevolucion().get(Calendar.MONTH)+"/"+this.getFechaDevolucion().get(Calendar.DATE);
