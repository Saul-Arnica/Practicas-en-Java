    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            FileInputStream archiFIS = new FileInputStream(
                "C:\\Users\\saula\\WorkSpace\\Java\\BlueJ_Facu\\Practico7Integrador\\ArchivoOriginal.dat");
            ...
            if(archivoOriginal.delete()) {//solamente si eliminamos el archivo Original.(Esto funciona ya que solo se elimina el archivo fisico, pero queda en memoria(virtual))
