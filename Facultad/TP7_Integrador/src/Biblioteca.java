...
public class Biblioteca{
    ...
    /**
     * Si el libro está prestado establece la fecha de devolucion del ultimo 
     * prestamo como la fecha de hoy y devuelve true, si no está prestado lanza un LibroNoPrestadoException
     */
    ...
    public boolean devolverLibro(Libro p_libro) throws LibroNoPrestadoException {
        if(p_libro.prestado() == true && this.getLibros().contains(p_libro)){
            ...
            throw new LibroNoPrestadoException("El libro " +
                                                p_libro.getTitulo() + 
                                                " no se puede devolver ya que se encuentra en la biblioteca");
        }
    }
    ...
    public ArrayList<Prestamo> prestamosVencidos(){
        ...
        for(Socio socio : this.getSocios()){
            for(Prestamo prestamo : socio.getPrestamos()){
                if(prestamo.vencido(fechaHoy) && prestamo.getFechaDevolucion() == null) {
    ...
    public String listaDeTitulos(){
        ...
        for(String titulo : titulos) {
            contador++;
            lista = lista + contador + ") Titulo: " + titulo + "\n";
        }
        return lista;
    }
    /**
